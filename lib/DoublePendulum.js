...
class DoublePendulum {
  ...
  update() {
    ...
    // Numerically integrate (using the semi-implicit Euler method) the calculated angular accelerations to find velocities and then integrate again to find theta1 and theta2
